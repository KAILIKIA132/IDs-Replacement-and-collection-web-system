...
<body>
    ...
    <section class="home-section">
      <nav>
        <div class="sidebar-button">
          ...
          <span class="dashboard">ANNOUNCE ANY INFO YUO MAY WISH TO PUBLIC</span>
        </div>
  ...
  <div class="givedetails">
    <h1>GIVE ALL THE DETAILS AS REQUESTED</h1>
  </div>
</div>
<pre>
...
<legend><p style="color: red;">MAKE AN ANNOUNCEMENT</p></legend>


<form name="frmContact" action="insertannouncement.php" method="post" >
<p>
    <div class="control">
        <label for="Name">Date Of Birth<span class="required">*</span></label>
        <input id="birthDate" name="announce_date" class="select" lang="de" placeholder="dd.mm.yyyy" type="date" date-format="dd.mm.yyyy" value="" autocomplete="bday">
</p>
<p style="padding: 50px;">
<label for="message">Message</label>
<textarea name="announcement" id="txtMessage"></textarea>
</p>
<p>&nbsp;</p>
<p>
